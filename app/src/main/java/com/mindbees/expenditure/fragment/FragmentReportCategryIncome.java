...
public class FragmentReportCategryIncome extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		View v = inflater.inflate(R.layout.fragment_report_cat_income, null);
...
//        tempList = seperateDate(selectedYear);
	...
	private void loadDat(int duration2) {
		...
		switch (duration) {
		case 101:
			loadDetils(selectedYear, "", Const.TAG_INCOME_ID, categoryId);
			break;

		case 102:
			loadDetils(tempList.get(1), tempList.get(0), Const.TAG_INCOME_ID, categoryId);
			break;
		case 103:
			String endYear = tempList.get(0)+"-"+"12"+"-"+"31";
			loadDetils(selectedYear, endYear, Const.TAG_INCOME_ID, categoryId);
			break;
