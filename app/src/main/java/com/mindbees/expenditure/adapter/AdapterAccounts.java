...
public class AdapterAccounts extends BaseAdapter{
	...
	Context context;
	public ArrayList<Accounts> allList;
	
	

	public AdapterAccounts(Context context, ArrayList<Accounts> allList) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if (v == null) {
			v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_row_acnt, null);
...
//			holder.imgShop = (ImageView) v.findViewById(R.id.categryIcon);
		...
		holder.tvtitle.setText(allList.get(position).getAccount_title());
