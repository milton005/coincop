...
public class AdapterAllReminder extends BaseAdapter{

	Context context;
	ArrayList<Reminder> allList;
	...
	public AdapterAllReminder(Context context, ArrayList<Reminder> allList) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
		 ...
		 List<String> tempList = seperateDate(allList.get(position).getReminderDate().trim());

		holder.tvReminderTitle.setText(allList.get(position).getReminderText());
